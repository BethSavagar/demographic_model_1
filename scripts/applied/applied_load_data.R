...
fix_age_data_full <- read_csv(paste0("data/Applied_parameters/",statefile),col_names=T)
var_demo_data_full <- read_csv(paste0("data/Applied_parameters/",demfile), col_names=T)
