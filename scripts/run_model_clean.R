...
transmission_filepath <- paste0("scripts/set-pars-transmission-",transmission_pars,".R")
source(transmission_filepath)

## Clean Parameters Environment? ##
clean_environment <- T
if(clean_environment == T){
  rm(imm_decay_corrected,test_data,test_age_data, kid_f_prop,you_f_prop,juv_f_prop,sub_f_prop,adu_f_prop,
