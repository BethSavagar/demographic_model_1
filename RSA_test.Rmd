...
```{r varpars_setup, include = F}
# set up lhs sample of variable input parameter space


#varpars = parameter sets for evaluation representing entire variable input space
```

```{r fix_pars, include = F}
# Define fixed demographic parameters & model structure
