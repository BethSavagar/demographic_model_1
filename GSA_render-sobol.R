...
tdate <- Sys.Date()
filename1 <- paste0("GSA_output_sobol_", tdate, ".csv")
filename2 <- paste0("GSA_pars-set_sobol_", tdate, ".csv")
# -----------------------
## MODEL PARAMETERS ##
...
cores=detectCores()
cl <- makeCluster(45) # for running locally
