...
ocOut.comparison <- bind_rows(ocOut.seasonalF %>% select(w, sum_pop, prop_immune) %>% mutate(id = "fixedseasonal"),
                   ocOut.seasonalV %>% select(w, sum_pop, prop_immune) %>% mutate(id = "variableseasonal"), 
                   ocOut.constantF %>% select(w, sum_pop, prop_immune) %>% mutate(id = "fixednNS"),
                   ocOut.constantV %>% select(w, sum_pop, prop_immune) %>% mutate(id = "variableNS"))
