...
filename_immDyn_nonseasonal12 <- "immDyn_nonseasonalV12_prof100.csv"
...
# immDynamics.clean <- read.csv("output/Applied/immDyn_nonseasonalV12_prof100.csv", row.names = F)
...
# ocOut.nonseasonalSumm <- read.csv("output/Applied/immDyn_nonseasonalSummV12_prof100.csv", row.names = F)
...
# immDynamics6.clean <- read_csv("output/Applied/immDyn_nonseasonalV6_prof100.csv") %>% select(-"...1")
...
# ocOut.nonseasonal6Summ <- read.csv("output/Applied/immDyn_nonseasonalSummV6_prof100.csv", row.names = F)
