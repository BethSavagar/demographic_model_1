---
title: "Regional Sensitivity Analysis BACKUP"
author: "Beth Savagar"
date: "2023-06-21"
output: pdf_document
---
...
- Preliminary simulations:
  ...
  - **Example 5**: Revert to use of original parameter boundaries `min.1` and `max.1` but update fixed_demographic parameter to `sim.2` i.e. adult female age = 12, male adult age = 2. Thihs produces population output much closer to the specified conditions.
