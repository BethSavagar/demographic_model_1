...
V2 = round(V1 + 11*4.345) # 11m after first vaccination (3m following initial vaccination+4m following end of birth peak)
...
if(plotsave){
  filename_immVarApp2 <- "OC_seasonalDyn_App.png"
  ggsave(paste0("plots/applied/",filename_immVarApp2), plot = plot_immVarApp2, width = 20, height = 10, units = "cm")
}
```
