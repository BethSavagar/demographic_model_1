...
R markdown script testing first version of flock dynamics model. Including testing maternal immunity decay, births and deaths and empirical test using basic BAOBAB data (NET offtake = 0)
