...
profile_ranges <- read.csv("data/Applied_parameters/cgiar-filter.csv")
...
for (i in 1:length(profs)){
  ...
  # Assuming par.mins and par.maxs are vectors with the min and max values for each parameter
