...
Overview
- Old file testing RSA function with LHS analysis. 
- Retain just in case it's useful down the line but not part of cleaned folder

```{r loaddata}
# this is data for old version of model probably not needed at all (Nov 23)
...
- Preliminary simulations:
  ...
  - **Age-Sex Str Dynamics**: `var_input_set <- read.csv("output/RSAoutput_morevars_220623.csv")` load parameters with behavioural 10 year growth to assess age-sex dynamics and overall pop dynamics in last 5-10 years.
...
# RSA_analysis_2.2 tenyr growth set:
# var_input_set <- tenyr_pars / valid_as_pars_df
# lhs_n <- nrow(var_input_set)
