...
# saveRDS(ocOut.sum, file = "output/Applied/applied_output_OC-profile-LHS10000.RData")
```
...
# ocOut.sum <- readRDS(file = "output/Applied/applied_output_OC-profile-LHS10000.RData")
